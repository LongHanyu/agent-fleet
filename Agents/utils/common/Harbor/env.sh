...
HARBOR_OPENCODE_RUN_TIMEOUT_SEC="${HARBOR_OPENCODE_RUN_TIMEOUT_SEC:-}"
...
HARBOR_WHEEL_SERVER_CLIENT_URL="${HARBOR_WHEEL_SERVER_CLIENT_URL:-}"
HARBOR_LOCAL_DOWNLOAD_HEADER="${HARBOR_LOCAL_DOWNLOAD_HEADER:-}"
...
export HARBOR_LOCAL_WHEEL_SERVER_URL HARBOR_LOCAL_CLAUDE_TGZ_URL HARBOR_WHEEL_SERVER_CLIENT_URL HARBOR_LOCAL_DOWNLOAD_HEADER HARBOR_REMOTE_WHEEL_SERVER_URLS EFFECTIVE_WHEEL_URL_FILE EFFECTIVE_CLAUDE_TGZ_URL_FILE LOCAL_DEPS_LOG_FILE HARBOR_RUNNER_PREPARE HARBOR_RUNNER_IMAGE_DIR HARBOR_RUNNER_HOST_DIR HARBOR_RUNNER_PYTHON_VERSION HARBOR_RUNNER_DIR HARBOR_OPIK_BIN HARBOR_CLI_BIN HARBOR_OPIK_PYTHON HARBOR_RUNNER_REQUIREMENTS HARBOR_RUNNER_PREPARE_STATUS_FILE HARBOR_RUNNER_PREPARE_LOG_FILE
...
export HARBOR_OPENCODE_RUN_TIMEOUT_SEC
...
harbor_prepare_or_select_wheels() {
  ...
  if harbor_local_cache_ready; then
    ...
    harbor_ensure_local_wheels_server
    harbor_write_effective_wheel_source "${HARBOR_WHEEL_SERVER_CLIENT_URL:-$HARBOR_LOCAL_WHEEL_SERVER_URL}"
    harbor_prewarm_s3_upload_cache || {
